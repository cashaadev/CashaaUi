...
@Component({
  selector: 'app-externalsell',
  templateUrl: 'externalsell.component.html',
  styleUrls: ['externalsell.component.css']
})
export class ExternalsellComponent implements OnInit {
  ...
  constructor(private resolver: ComponentFactoryResolver) { }
   ...
   private componentReference: ComponentRef<any>;
     ...
     protected entity = { 
        ...
        description: "This is External Sell" 
      };
